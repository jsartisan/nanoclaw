...
```yaml
- uses: nanocoai/clawie/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [Clawie](https://github.com/nanocoai/Clawie) | ![tokens](https://raw.githubusercontent.com/nanocoai/Clawie/main/repo-tokens/badge.svg) |
