  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'inset-y-0 z-10 hidden h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-out md:flex',
          side === 'left'
...
function SidebarMenu({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn('flex min-h-0 w-full min-w-0 flex-col gap-1', className)}
      {...props}
    />
  );
}
