...
const track = tv({
  base: 'inline-flex h-[calc((var(--spacing)*4)+2px)] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none',
  variants: {
    isSelected: {
      false: 'bg-secondary dark:bg-secondary/80',
      true: 'bg-primary',
    },
    isFocusVisible: {
