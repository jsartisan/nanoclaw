    ...
    >
      {composeRenderProps(props.children, (children, { isSelected }) => (
        <>
          ...
          {isSelected && <Icon icon={IconCheck} size="sm" />}
        </>
      ))}
    </AriaListBoxItem>
  );
...
export function DropdownSection<T extends object>(
  ...
  return (
    <ListBoxSection className="group/section after:block after:h-[5px] after:content-[''] first:-mt-[5px]">
      <Header className="text-muted-foreground trin- sticky -top-[5px] z-10 -mx-1 -mt-px truncate px-4 py-1 text-xs font-medium backdrop-blur-md group-first/section:mt-1 [&+*]:mt-1">
        {props.title}
      </Header>
