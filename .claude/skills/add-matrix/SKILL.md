...
Clawie doesn't ship channels in trunk. This skill copies the Matrix adapter in from the `channels` branch.
...
MATRIX_DEVICE_ID=CLAWIE01                    # Stable device ID across restarts
```
