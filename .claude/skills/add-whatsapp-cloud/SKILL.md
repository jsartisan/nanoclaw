...
Connect Clawie to WhatsApp via the official Meta WhatsApp Business Cloud API.

## Install

Clawie doesn't ship channels in trunk. This skill copies the WhatsApp Cloud adapter in from the `channels` branch.
