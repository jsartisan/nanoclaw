...
Clawie doesn't ship channels in trunk. This skill copies the Discord adapter in from the `channels` branch.
...
2. Click **New Application** and give it a name (e.g., "Clawie Assistant")
