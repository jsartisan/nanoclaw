...
Connect Clawie to email via Resend for async email conversations.

## Install

Clawie doesn't ship channels in trunk. This skill copies the Resend adapter in from the `channels` branch.
