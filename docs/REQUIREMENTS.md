...
Clawie gives you the core functionality without that mess.
...
> **Note:** Telegram, Slack, Discord, Gmail, and Apple Container skills already exist. See the [skills documentation](https://docs.clawie.dev/integrations/skills-system) for the full list.
...
- Custom `clawie` MCP server (inside container) provides scheduling tools
...
- `/update-clawie` - Pull upstream changes, merge with customizations
...
**Clawie** - A reference to Clawdbot (now OpenClaw).
